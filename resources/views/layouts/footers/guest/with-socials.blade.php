      ...
      <div class="container">
          ...
          <div class="row">
              <div class="col-8 mx-auto text-center">
                  <p class="mb-0 text-secondary">Copyright © {{ now()->year }} Desarrollado por <a style="color: #252f40;" href=""class="font-weight-bold ml-1" target="_blank">Juntos Somos Mas</a> &amp; <a style="color: #252f40;" href="" class="font-weight-bold ml-1" target="_blank">Codemaster</a>
              </div>
              </p>
          </div>
      </div>
